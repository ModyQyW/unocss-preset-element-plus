...
describe('theme', () => {
  ...
  test('theme colors with colors', async () => {
    ...
    expect(css).toMatchInlineSnapshot(`
      ...
      *,::before,::after{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgba(0,0,0,0);--un-ring-shadow:0 0 rgba(0,0,0,0);--un-shadow-inset: ;--un-shadow:0 0 rgba(0,0,0,0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgba(147,197,253,0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}::backdrop{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgba(0,0,0,0);--un-ring-shadow:0 0 rgba(0,0,0,0);--un-shadow-inset: ;--un-shadow:0 0 rgba(0,0,0,0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgba(147,197,253,0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}
      ...
      /* layer: default */
      .text-danger{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-DEFAULT),var(--un-text-opacity));}
      .text-danger-dark-1{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-dark-1),var(--un-text-opacity));}
      .text-danger-dark-2{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-dark-2),var(--un-text-opacity));}
      .text-danger-dark-3{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-dark-3),var(--un-text-opacity));}
      .text-danger-dark-4{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-dark-4),var(--un-text-opacity));}
      .text-danger-dark-5{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-dark-5),var(--un-text-opacity));}
      .text-danger-dark-6{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-dark-6),var(--un-text-opacity));}
      .text-danger-dark-7{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-dark-7),var(--un-text-opacity));}
      .text-danger-dark-8{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-dark-8),var(--un-text-opacity));}
      .text-danger-dark-9{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-dark-9),var(--un-text-opacity));}
      .text-danger-light-1{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-light-1),var(--un-text-opacity));}
      .text-danger-light-2{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-light-2),var(--un-text-opacity));}
      .text-danger-light-3{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-light-3),var(--un-text-opacity));}
      .text-danger-light-4{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-light-4),var(--un-text-opacity));}
      .text-danger-light-5{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-light-5),var(--un-text-opacity));}
      .text-danger-light-6{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-light-6),var(--un-text-opacity));}
      .text-danger-light-7{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-light-7),var(--un-text-opacity));}
      .text-danger-light-8{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-light-8),var(--un-text-opacity));}
      .text-danger-light-9{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-danger-light-9),var(--un-text-opacity));}
      .text-error{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-DEFAULT),var(--un-text-opacity));}
      .text-error-dark-1{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-dark-1),var(--un-text-opacity));}
      .text-error-dark-2{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-dark-2),var(--un-text-opacity));}
      .text-error-dark-3{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-dark-3),var(--un-text-opacity));}
      .text-error-dark-4{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-dark-4),var(--un-text-opacity));}
      .text-error-dark-5{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-dark-5),var(--un-text-opacity));}
      .text-error-dark-6{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-dark-6),var(--un-text-opacity));}
      .text-error-dark-7{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-dark-7),var(--un-text-opacity));}
      .text-error-dark-8{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-dark-8),var(--un-text-opacity));}
      .text-error-dark-9{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-dark-9),var(--un-text-opacity));}
      .text-error-light-1{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-light-1),var(--un-text-opacity));}
      .text-error-light-2{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-light-2),var(--un-text-opacity));}
      .text-error-light-3{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-light-3),var(--un-text-opacity));}
      .text-error-light-4{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-light-4),var(--un-text-opacity));}
      .text-error-light-5{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-light-5),var(--un-text-opacity));}
      .text-error-light-6{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-light-6),var(--un-text-opacity));}
      .text-error-light-7{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-light-7),var(--un-text-opacity));}
      .text-error-light-8{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-light-8),var(--un-text-opacity));}
      .text-error-light-9{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-error-light-9),var(--un-text-opacity));}
      .text-info{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-DEFAULT),var(--un-text-opacity));}
      .text-info-dark-1{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-dark-1),var(--un-text-opacity));}
      .text-info-dark-2{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-dark-2),var(--un-text-opacity));}
      .text-info-dark-3{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-dark-3),var(--un-text-opacity));}
      .text-info-dark-4{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-dark-4),var(--un-text-opacity));}
      .text-info-dark-5{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-dark-5),var(--un-text-opacity));}
      .text-info-dark-6{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-dark-6),var(--un-text-opacity));}
      .text-info-dark-7{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-dark-7),var(--un-text-opacity));}
      .text-info-dark-8{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-dark-8),var(--un-text-opacity));}
      .text-info-dark-9{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-dark-9),var(--un-text-opacity));}
      .text-info-light-1{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-light-1),var(--un-text-opacity));}
      .text-info-light-2{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-light-2),var(--un-text-opacity));}
      .text-info-light-3{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-light-3),var(--un-text-opacity));}
      .text-info-light-4{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-light-4),var(--un-text-opacity));}
      .text-info-light-5{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-light-5),var(--un-text-opacity));}
      .text-info-light-6{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-light-6),var(--un-text-opacity));}
      .text-info-light-7{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-light-7),var(--un-text-opacity));}
      .text-info-light-8{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-light-8),var(--un-text-opacity));}
      .text-info-light-9{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-info-light-9),var(--un-text-opacity));}
      .text-primary{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-DEFAULT),var(--un-text-opacity));}
      .text-primary-dark-1{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-dark-1),var(--un-text-opacity));}
      .text-primary-dark-2{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-dark-2),var(--un-text-opacity));}
      .text-primary-dark-3{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-dark-3),var(--un-text-opacity));}
      .text-primary-dark-4{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-dark-4),var(--un-text-opacity));}
      .text-primary-dark-5{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-dark-5),var(--un-text-opacity));}
      .text-primary-dark-6{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-dark-6),var(--un-text-opacity));}
      .text-primary-dark-7{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-dark-7),var(--un-text-opacity));}
      .text-primary-dark-8{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-dark-8),var(--un-text-opacity));}
      .text-primary-dark-9{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-dark-9),var(--un-text-opacity));}
      .text-primary-light-1{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-light-1),var(--un-text-opacity));}
      .text-primary-light-2{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-light-2),var(--un-text-opacity));}
      .text-primary-light-3{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-light-3),var(--un-text-opacity));}
      .text-primary-light-4{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-light-4),var(--un-text-opacity));}
      .text-primary-light-5{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-light-5),var(--un-text-opacity));}
      .text-primary-light-6{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-light-6),var(--un-text-opacity));}
      .text-primary-light-7{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-light-7),var(--un-text-opacity));}
      .text-primary-light-8{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-light-8),var(--un-text-opacity));}
      .text-primary-light-9{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-primary-light-9),var(--un-text-opacity));}
      .text-success{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-DEFAULT),var(--un-text-opacity));}
      .text-success-dark-1{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-dark-1),var(--un-text-opacity));}
      .text-success-dark-2{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-dark-2),var(--un-text-opacity));}
      .text-success-dark-3{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-dark-3),var(--un-text-opacity));}
      .text-success-dark-4{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-dark-4),var(--un-text-opacity));}
      .text-success-dark-5{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-dark-5),var(--un-text-opacity));}
      .text-success-dark-6{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-dark-6),var(--un-text-opacity));}
      .text-success-dark-7{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-dark-7),var(--un-text-opacity));}
      .text-success-dark-8{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-dark-8),var(--un-text-opacity));}
      .text-success-dark-9{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-dark-9),var(--un-text-opacity));}
      .text-success-light-1{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-light-1),var(--un-text-opacity));}
      .text-success-light-2{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-light-2),var(--un-text-opacity));}
      .text-success-light-3{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-light-3),var(--un-text-opacity));}
      .text-success-light-4{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-light-4),var(--un-text-opacity));}
      .text-success-light-5{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-light-5),var(--un-text-opacity));}
      .text-success-light-6{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-light-6),var(--un-text-opacity));}
      .text-success-light-7{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-light-7),var(--un-text-opacity));}
      .text-success-light-8{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-light-8),var(--un-text-opacity));}
      .text-success-light-9{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-success-light-9),var(--un-text-opacity));}
      .text-warning{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-DEFAULT),var(--un-text-opacity));}
      .text-warning-dark-1{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-dark-1),var(--un-text-opacity));}
      .text-warning-dark-2{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-dark-2),var(--un-text-opacity));}
      .text-warning-dark-3{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-dark-3),var(--un-text-opacity));}
      .text-warning-dark-4{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-dark-4),var(--un-text-opacity));}
      .text-warning-dark-5{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-dark-5),var(--un-text-opacity));}
      .text-warning-dark-6{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-dark-6),var(--un-text-opacity));}
      .text-warning-dark-7{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-dark-7),var(--un-text-opacity));}
      .text-warning-dark-8{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-dark-8),var(--un-text-opacity));}
      .text-warning-dark-9{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-dark-9),var(--un-text-opacity));}
      .text-warning-light-1{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-light-1),var(--un-text-opacity));}
      .text-warning-light-2{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-light-2),var(--un-text-opacity));}
      .text-warning-light-3{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-light-3),var(--un-text-opacity));}
      .text-warning-light-4{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-light-4),var(--un-text-opacity));}
      .text-warning-light-5{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-light-5),var(--un-text-opacity));}
      .text-warning-light-6{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-light-6),var(--un-text-opacity));}
      .text-warning-light-7{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-light-7),var(--un-text-opacity));}
      .text-warning-light-8{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-light-8),var(--un-text-opacity));}
      .text-warning-light-9{--un-text-opacity:1;color:rgba(var(--un-preset-el-colors-warning-light-9),var(--un-text-opacity));}"
    `);
  });
  ...
  test('text colors with css variables', async () => {
    ...
    expect(css).toMatchInlineSnapshot(`
      ...
      *,::before,::after{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgba(0,0,0,0);--un-ring-shadow:0 0 rgba(0,0,0,0);--un-shadow-inset: ;--un-shadow:0 0 rgba(0,0,0,0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgba(147,197,253,0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}::backdrop{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgba(0,0,0,0);--un-ring-shadow:0 0 rgba(0,0,0,0);--un-shadow-inset: ;--un-shadow:0 0 rgba(0,0,0,0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgba(147,197,253,0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}
      /* layer: default */
      .text-disabled-text{color:var(--el-text-color-disabled);}
      .text-placeholder-text{color:var(--el-text-color-placeholder);}
      .text-primary-text{color:var(--el-text-color-primary);}
      .text-regular-text{color:var(--el-text-color-regular);}
      .text-secondary-text{color:var(--el-text-color-secondary);}"
    `);
  });
